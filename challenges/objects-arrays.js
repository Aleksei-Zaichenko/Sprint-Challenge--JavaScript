...
graduates.forEach(student=>{
  ...
  let nameEmail = (student.first_name + ' ' + student.email);
...
zooAnimals.forEach(animal => {
  ...
  let animalScientificName = `Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}`;

  displayNames.push(animalScientificName);
...
const populationTotal = zooAnimals.reduce((accumulator, animal) => {
  return accumulator + animal.population;}, 0);
